...
export function deletePersonalThemeMethod(this: ApiClientFacade, id: string) { return this.request<AccountMutationResult>('DELETE', `/v1/auth/web/themes/${encodeURIComponent(id)}`); }
