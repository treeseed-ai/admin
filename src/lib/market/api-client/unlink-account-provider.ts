...
export function unlinkAccountProviderMethod(this: ApiClientFacade, identityId: string) { return this.request<AccountMutationResult>('DELETE', `/v1/auth/web/providers/${encodeURIComponent(identityId)}`); }
