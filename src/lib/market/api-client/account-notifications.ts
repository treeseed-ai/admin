...
export function accountNotificationsMethod(this: ApiClientFacade, limit = 20) { return this.request<AccountNotification[]>('GET', `/v1/auth/web/notifications?limit=${encodeURIComponent(String(limit))}`); }
