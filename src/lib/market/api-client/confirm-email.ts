...
export function confirmEmailMethod(this: ApiClientFacade, token: string) { return this.request<WebAuthenticationResult>('POST', '/v1/auth/web/confirm-email', { body: { token } }); }
