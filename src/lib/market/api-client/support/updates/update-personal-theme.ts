...
export function updatePersonalThemeMethod(this: ApiClientFacade, id: string, body: PersonalThemeDraft) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.updateTheme, { path: { themeId: id }, query: {}, body: { ...body } }) as unknown as Promise<PersonalTheme>; }
