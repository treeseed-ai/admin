...
export function updatePersonalThemeMethod(this: ApiClientFacade, id: string, body: PersonalThemeDraft, ifMatch: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.updateTheme, { path: { themeId: id }, query: {}, body: { ...body } }, { ifMatch }) as unknown as Promise<PersonalTheme>; }
