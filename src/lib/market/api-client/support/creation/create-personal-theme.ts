...
export function createPersonalThemeMethod(this: ApiClientFacade, body: PersonalThemeDraft) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.createTheme, { path: {}, query: {}, body: { ...body } }) as unknown as Promise<PersonalTheme>; }
