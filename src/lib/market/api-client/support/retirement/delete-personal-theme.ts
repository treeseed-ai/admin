...
export function deletePersonalThemeMethod(this: ApiClientFacade, id: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.deleteTheme, { path: { themeId: id }, query: {}, body: {} }) as unknown as Promise<AccountMutationResult>; }
