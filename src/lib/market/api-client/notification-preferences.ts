...
export function notificationPreferencesMethod(this: ApiClientFacade) { return this.request<NotificationPreferences>('GET', '/v1/auth/web/notifications/preferences'); }
