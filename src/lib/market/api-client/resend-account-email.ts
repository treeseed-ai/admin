...
export function resendAccountEmailMethod(this: ApiClientFacade, emailId: string) { return this.request<AccountEmailMutationResult>('POST', `/v1/auth/web/emails/${encodeURIComponent(emailId)}/verify`, { body: {} }); }
