...
export function loadTeamProfileByNameMethod(this: ApiClientFacade, name: string) {
    return this.invoke(CONTROL_PLANE_OPERATIONS.teams.profile, { path: { name }, query: {}, body: undefined }).catch(() => null);
}
