...
export function evaluateTeamDeletionBlockersMethod(this: ApiClientFacade, teamId: string) {
    return this.invoke(CONTROL_PLANE_OPERATIONS.teams.deletionReadiness, { path: { teamId }, query: {}, body: undefined });
}
