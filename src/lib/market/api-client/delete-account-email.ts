...
export function deleteAccountEmailMethod(this: ApiClientFacade, emailId: string) { return this.request<AccountEmailAddress[]>('DELETE', `/v1/auth/web/emails/${encodeURIComponent(emailId)}`); }
