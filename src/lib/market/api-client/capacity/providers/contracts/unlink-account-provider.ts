...
export function unlinkAccountProviderMethod(this: ApiClientFacade, identityId: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.unlinkProvider, { path: { identityId }, query: {}, body: {} }) as unknown as Promise<AccountMutationResult>; }
