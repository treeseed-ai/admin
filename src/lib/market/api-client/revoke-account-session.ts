...
export function revokeAccountSessionMethod(this: ApiClientFacade, sessionId: string) { return this.request<AccountMutationResult>('POST', `/v1/auth/web/sessions/${encodeURIComponent(sessionId)}/revoke`, { body: {} }); }
