...
export function addAccountEmailMethod(this: ApiClientFacade, email: string) { return this.request<AccountEmailMutationResult>('POST', '/v1/auth/web/emails', { body: { email } }); }
