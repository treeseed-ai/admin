...
export function addAccountEmailMethod(this: ApiClientFacade, email: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.addEmail, { path: {}, query: {}, body: { email } }) as unknown as Promise<AccountEmailMutationResult>; }
