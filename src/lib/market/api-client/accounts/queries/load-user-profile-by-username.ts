...
export function loadUserProfileByUsernameMethod(this: ApiClientFacade, username: string) {
    return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.publicProfile, { path: { username }, query: {}, body: undefined }).catch(() => null);
}
