...
export function setPrimaryAccountEmailMethod(this: ApiClientFacade, emailId: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.makePrimaryEmail, { path: { emailId }, query: {}, body: {} }) as unknown as Promise<AccountEmailMutationResult>; }
