...
export function setPrimaryAccountEmailMethod(this: ApiClientFacade, emailId: string, ifMatch: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.makePrimaryEmail, { path: { emailId }, query: {}, body: {} }, { ifMatch }) as unknown as Promise<AccountEmailMutationResult>; }
