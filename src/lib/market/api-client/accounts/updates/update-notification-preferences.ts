...
export function updateNotificationPreferencesMethod(this: ApiClientFacade, body: NotificationPreferences) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.updateNotificationPreferences, { path: {}, query: {}, body: { ...body } }) as unknown as Promise<NotificationPreferences>; }
