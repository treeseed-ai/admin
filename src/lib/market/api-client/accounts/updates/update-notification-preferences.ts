...
export function updateNotificationPreferencesMethod(this: ApiClientFacade, body: NotificationPreferences) { return this.request<NotificationPreferences>('PUT', '/v1/auth/web/notifications/preferences', { body }); }
