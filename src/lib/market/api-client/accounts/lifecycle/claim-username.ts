...
export function claimUsernameMethod(this: ApiClientFacade, username: string, ifMatch: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.updateUsername, { path: {}, query: {}, body: { username } }, { ifMatch }) as unknown as Promise<UsernameClaimResult>; }
