...
export function claimUsernameMethod(this: ApiClientFacade, username: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.updateUsername, { path: {}, query: {}, body: { username } }) as unknown as Promise<UsernameClaimResult>; }
