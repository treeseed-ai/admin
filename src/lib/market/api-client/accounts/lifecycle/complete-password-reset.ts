...
export function completePasswordResetMethod(this: ApiClientFacade, token: string, newPassword: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.completePasswordReset, { path: {}, query: {}, body: { token, newPassword } }) as unknown as Promise<{
    changed: true;
}>; }
