...
export function revokeAccountSessionMethod(this: ApiClientFacade, sessionId: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.revokeSession, { path: { sessionId }, query: {}, body: {} }) as unknown as Promise<AccountMutationResult>; }
