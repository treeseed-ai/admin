...
export function resendAccountEmailMethod(this: ApiClientFacade, emailId: string) { return this.invoke(CONTROL_PLANE_OPERATIONS.accounts.verifyEmail, { path: { emailId }, query: {}, body: {} }) as unknown as Promise<AccountEmailMutationResult>; }
