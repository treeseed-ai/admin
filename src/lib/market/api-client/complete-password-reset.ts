...
export function completePasswordResetMethod(this: ApiClientFacade, token: string, newPassword: string) { return this.request<{
    changed: true;
}>('POST', '/v1/auth/web/password-reset/complete', { body: { token, newPassword } }); }
