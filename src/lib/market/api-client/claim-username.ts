...
export function claimUsernameMethod(this: ApiClientFacade, username: string) { return this.request<UsernameClaimResult>('PATCH', '/v1/auth/web/username', { body: { username } }); }
