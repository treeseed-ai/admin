...
export function setPrimaryAccountEmailMethod(this: ApiClientFacade, emailId: string) { return this.request<AccountEmailMutationResult>('POST', `/v1/auth/web/emails/${encodeURIComponent(emailId)}/primary`, { body: {} }); }
