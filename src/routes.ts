...
export const ADMIN_ROUTES: readonly SiteRouteContribution[] = validateRouteCapabilities([
	...
	adminRoute('/app/work/agents', 'pages/app/work/agents.astro', { id: 'admin.agent-lab.agents', description: 'Configured and active Agent Lab agent summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	...
	adminRoute('/app/work/events', 'pages/app/work/events.astro', { id: 'admin.agent-lab.events', description: 'Durable Agent Lab system-event summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/assignments', 'pages/app/work/assignments.astro', { id: 'admin.agent-lab.assignments', description: 'Operating-day assignment summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/executions', 'pages/app/work/executions.astro', { id: 'admin.agent-lab.executions', description: 'Native execution-attempt summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/artifacts', 'pages/app/work/artifacts.astro', { id: 'admin.agent-lab.artifacts', description: 'Durable Agent Lab artifact summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	...
	adminRoute('/app/market', 'pages/app/domain-overview.astro', { id: 'admin.domain.market', description: 'Bounded active-team catalog and billing domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
