...
export const ADMIN_ROUTES: readonly SiteRouteContribution[] = validateRouteCapabilities([
	...
	adminRoute('/app/work/inbox', 'pages/app/work/inbox.astro', { id: 'admin.agent-lab.inbox', description: 'Agent Lab proposals and operational errors.' }),
	adminRoute('/app/work/decisions', 'pages/app/work/decisions.astro', { id: 'admin.agent-lab.decisions', description: 'Agent Lab proposals, decisions, assignments, and outcomes.' }),
	adminRoute('/app/work/build', 'pages/app/work/build.astro', { id: 'admin.agent-lab.build', description: 'Agent design and simulation entry surface.' }),
	adminRoute('/app/work/direction', 'pages/app/work/direction.astro', { id: 'admin.agent-lab.direction', description: 'Assignment and execution direction timeline.' }),
	adminRoute('/app/work/results', 'pages/app/work/results.astro', { id: 'admin.agent-lab.results', description: 'Agent artifacts, summaries, and reports.' }),
	adminRoute('/app/work/find', 'pages/app/work/find.astro', { id: 'admin.agent-lab.find', description: 'Cross-entity Agent Lab search.' }),
	adminRoute('/app/work/agents', 'pages/app/work/entity-overview.astro', { id: 'admin.agent-lab.agents', description: 'Configured and active Agent Lab agent summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/workdays', 'pages/app/work/workdays.astro', { id: 'admin.agent-lab.workdays', description: 'Operating-day workday summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/events', 'pages/app/work/entity-overview.astro', { id: 'admin.agent-lab.events', description: 'Durable Agent Lab system-event summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/assignments', 'pages/app/work/entity-overview.astro', { id: 'admin.agent-lab.assignments', description: 'Operating-day assignment summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/executions', 'pages/app/work/entity-overview.astro', { id: 'admin.agent-lab.executions', description: 'Native execution-attempt summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	adminRoute('/app/work/artifacts', 'pages/app/work/entity-overview.astro', { id: 'admin.agent-lab.artifacts', description: 'Durable Agent Lab artifact summaries.', guarantees: ['guarantee.work.agent-lab.monitor-agent-lab.035'] }),
	...
	adminRoute('/app/market', 'pages/app/market.astro', { id: 'admin.domain.market', description: 'Bounded active-team catalog and billing domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
