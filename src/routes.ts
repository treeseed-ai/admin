...
export const ADMIN_ROUTES: readonly SiteRouteContribution[] = validateRouteCapabilities([
	...
	adminRoute('/app/services/vaults', 'pages/app/services/vaults.astro', { id: 'admin.services.vaults', description: 'Development-only vault setup preview; released builds redirect to connections.', guarantees: [], knowledgePageIds: ['services.vaults'] }),
	...
	adminRoute('/app/capacity', 'pages/app/capacity/index.astro', { id: 'admin.domain.capacity', description: 'Provider list, health and pending approval.', guarantees: ['guarantee.work.command.monitor-team-operations.033'] }),
	adminRoute('/app/capacity/registration', 'pages/app/capacity/registration.astro', { id: 'admin.capacity.registration', description: 'Team provider registration code and installation.' }),
	adminRoute('/app/capacity/install', 'pages/app/capacity/install.astro', { id: 'admin.capacity.install', description: 'Prepare a team capacity provider installation.', knowledgePageIds: ['capacity.registration'] }),
	adminRoute('/app/capacity/install-download', 'pages/app/capacity/install-download.ts', { id: 'admin.capacity.install-download', description: 'Download authorized team registration configuration.', responseKind: 'data', archetype: 'action', navigation: 'hidden', knowledgePageIds: ['capacity.registration'] }),
	adminRoute('/app/ai', 'pages/app/ai/index.astro', { id: 'admin.domain.ai', description: 'Team inference and training instances.' }),
	adminRoute('/app/ai/new', 'pages/app/ai/new.astro', { id: 'admin.ai.setup', description: 'Connection-backed AI instance setup.' }),
	adminRoute('/app/chat', 'pages/app/chat/index.astro', { id: 'admin.workspace.chat', description: 'Persistent team and agent correspondence workspace.' }),
