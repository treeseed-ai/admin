...
export const ADMIN_ROUTES: readonly SiteRouteContribution[] = validateRouteCapabilities([
	...
	adminRoute('/app/teams/[teamId]', 'pages/app/teams/[teamId]/index.astro', { id: 'admin.team.overview', description: 'Authenticated operational team overview with bounded domain summaries and recent audit activity.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
	...
	adminRoute('/app/projects', 'pages/app/domain-overview.astro', { id: 'admin.domain.projects', description: 'Bounded active-team project domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
	adminRoute('/app/hosts', 'pages/app/domain-overview.astro', { id: 'admin.domain.hosts', description: 'Bounded active-team hosting domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
	adminRoute('/app/capacity', 'pages/app/domain-overview.astro', { id: 'admin.domain.capacity', description: 'Bounded active-team capacity domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
	adminRoute('/app/knowledge', 'pages/app/domain-overview.astro', { id: 'admin.domain.knowledge', description: 'Bounded active-team knowledge domain landing page.', guarantees: ['guarantee.team.team.view-team-overview.015'] }),
