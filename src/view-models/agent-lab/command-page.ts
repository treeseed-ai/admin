...
export async function loadAgentLabCommandPage(context: APIContext, surface: AgentLabCommandSurface) {
	...
	return { app, preferences, frame, surface: initial as CommandCollectionPage, query, endpoints: { collection, detailBase: `${base}/details`, state: `${base}/view-state`, actions: `${base}/surfaces/${surface}`, simulations: `${base}/simulations`, draft: `${base}/surfaces/build/draft`, authoringBundle: `${base}/surfaces/build/authoring-bundle` } };
}
